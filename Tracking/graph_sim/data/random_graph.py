...
class RandomGraphDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print('gTruth : ',gTruth.shape,gTruth)
...
if __name__ == '__main__':
    ...
    dataset = RandomGraphDataset(10,15, 0,5)
    a,b,c,d,e,f = dataset.__getitem__(10)
